...
app.controller("consultas", function($scope, $http) {
	...
	$scope.consulta1 = function () {
		...
		$http.post("http://192.168.43.228:3000/transactions/tickets_genre", {
	...
	$scope.consulta2 = function () {
		...
		$http.post("http://192.168.43.228:3000/transactions/tickets_province", {
            		name: $scope.selected_event
        	})
        	.success(function (data, status, headers, config) {
			console.log(data);
	...
	$scope.consulta3 = function () {
		...
		$http.get("http://192.168.43.228:3000/transactions/sales_by_event")
        	.success(function(data)	{         
        		$scope.result = data;
			console.log(data);
    		})
	...
	$scope.consulta4 = function () {
		...
		$http.get("http://192.168.43.228:3000/transactions/sales_by_province")
        	.success(function(data)	{         
        		$scope.result = data;
			console.log(data);
    		})
	...
	$scope.consulta6 = function () {
		...
		$http.get("http://192.168.43.228:3000/transactions/tickets_by_client")
        	.success(function(data)	{         
        		$scope.result = data;
			console.log(data);
    		})
